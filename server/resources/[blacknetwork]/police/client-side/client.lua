...
-----------------------------------------------------------------------------------------------------------------------------------------
-- gregosinitPrision --  chamada pela evento do server, servindo apenas para executar a funcão que esta no mesmo
-----------------------------------------------------------------------------------------------------------------------------------------

RegisterNetEvent("police:initPrison")
AddEventHandler("police:initPrison",function (nuser_id,services,fines,text)
    vSERVER.initPrison(nuser_id,services,fines,text)
end)
-----------------------------------------------------------------------------------------------------------------------------------------
-- POLICE:UPDATE
-----------------------------------------------------------------------------------------------------------------------------------------
