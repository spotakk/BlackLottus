    ...
    switch (event.data.action) {
        ...
        case 'bankmenu':
            if (selectedWindow == "loading_data") {
                ...
                setTimeout(function() {
                    ...
                    popup_sound.play();
                    console.log(event.data.playerSex)
        ...
        case 'multas_page':
            ...
            for (var i = 0; i < num; i++) {
                ...
                data = `<td class="align-middle" style="font-weight: 500;">
					De <span style="color: #377c31; font-weight: 600;">${db.nuser_id}</span>
					<div style="margin-top: -5px;">${db.date}</div>
				</td>`;
                amount = `<td class="align-middle pay-fine" data-id-key="${db.id}" data-price-key="${db.price}" style="font-weight: 500;"><span style="color: #2ecc71; float: right;"> ${db.price.toLocaleString()}</span> </td>`;
        ...
        case 'society_transactions':
            ...
            for (var i = 0; i < num; i++) {
                ...
                if (db.type == 'transfer' && db.receiver_identifier == event.data.identifier) {
                    icon = '<td class="align-middle"><span style="background-color: #1d1e24; padding: 10px 15px 10px 15px; border-radius: 10px;"><i class="bi bi-download"></i></span></td>';
                    data = `<td class="align-middle" style="font-weight: 500;">
								De <span style="color: #1d1e24; font-weight: 600;">${db.sender_name}</span>
								<div style="margin-top: -5px;">Received</div>
							</td>`;
                    amount = `<td class="align-middle" style="font-weight: 500;"><span style="color: #1d1e24; float: right;">+ ${db.value.toLocaleString()}$</span> </td>`;
                    // Sent
                    ...
                    data = `<td class="align-middle" style="font-weight: 500;">
								To <span style="color: #1d1e24; font-weight: 600;">${db.receiver_name}</span>
								<div style="margin-top: -5px;">Enviado</div>
							</td>`;
                    ...
                    icon = '<td class="align-middle"><span style="background-color: #1d1e24; padding: 10px 15px 10px 15px; border-radius: 10px;"><i class="bi bi-download"></i></span></td>';
                    data = `<td class="align-middle" style="font-weight: 500;">
								Em <span style="color: #1d1e24; font-weight: 600;">${db.receiver_name}</span>
								<div style="margin-top: -5px;">Depositado</div>
							</td>`;
                    amount = `<td class="align-middle" style="font-weight: 500;"><span style="color: #1d1e24; float: right;">+ ${db.value.toLocaleString()}$</span> </td>`;
                    // Withdrawn
            ...
            $('#page_info').html(`
				<div class="row mb-3">
					<div class="col col-md-3">
						<div class="card" style="background-color: #1d1e24; border-radius: 10px; color: #fff;">
				...
				<table id="transactionsTable">
					<tbody id="transactionsData">
						<tr>
							<td class="align-middle"><span style="background-color: #1a1a1a; padding: 5px 10px 5px 10px; border-radius: 10px;"><i class="bi bi-download"></i></span></td>
							<td class="align-middle" style="font-weight: 500; font-size: 16px;">
								To <span style="color: #1d1e24;">Arthur James</span>
								<div style="margin-top: -5px;">Enviado</div>
							</td>
							<td class="align-middle" style="font-weight: 500;">28 Aug 04:43</td>
							<td class="align-middle" style="font-weight: 500;">- 732 500$</td>
						...
						<tr>
							<td class="align-middle"><span style="background-color: #1a1a1a; padding: 5px 10px 5px 10px; border-radius: 10px;"><i class="bi bi-upload"></i></span></td>
							<td class="align-middle" style="font-weight: 500; font-size: 16px;">
								Em <span style="color: #1d1e24;">Conta do banco</span>
								<div style="margin-top: -5px;">Depositado</div>
							</td>
							<td class="align-middle" style="font-weight: 500;">28 Aug 04:43</td>
							<td class="align-middle" style="font-weight: 500; color: #1d1e24;">+ 57 000$</td>
						</tr>
					</tbody>
				</table>
			`);
        ...
        case 'transactions_page':
            ...
            for (var i = 0; i < num; i++) {
                ...
                // Received
                if (db.type == 'transfer' && db.receiver_identifier == event.data.identifier) {
                    icon = '<td class="align-middle"><span style="background-color: #1a1a1a; padding: 10px 15px 10px 15px; border-radius: 10px;"><i class="bi bi-download"></i></span></td>';
                    data = `<td class="align-middle" style="font-weight: 500;">
								De <span style="color: #1d1e24; font-weight: 600;">${db.sender_name}</span>
                    ...
                    icon = '<td class="align-middle"><span style="background-color: #1a1a1a; padding: 10px 15px 10px 15px; border-radius: 10px;"><i class="bi bi-upload"></i></span></td>';
                    data = `<td class="align-middle" style="font-weight: 500;">
								To <span style="color: #1d1e24; font-weight: 600;">${db.receiver_name}</span>
								<div style="margin-top: -5px;">Enviado</div>
							</td>`;
				...
				<table id="transactionsTable">
					<tbody id="transactionsData">
						...
						<tr>
							<td class="align-middle"><span style="background-color: #1a1a1a; padding: 5px 10px 5px 10px; border-radius: 10px;"><i class="bi bi-upload"></i></span></td>
							<td class="align-middle" style="font-weight: 500; font-size: 16px;">
								Em <span style="color: #1d1e24;">Conta bancária</span>
								<div style="margin-top: -5px;">Depositado</div>
							</td>
							<td class="align-middle" style="font-weight: 500;">28 Aug 04:43</td>
							<td class="align-middle" style="font-weight: 500; color: #1d1e24;">+ 57 000$</td>
...
function overview_page_function(event) {
					...
					<div class="card-body" style="background-color: #1d1e24; border-bottom-left-radius: 10px; border-bottom-right-radius: 10px; font-size: 16px;">
						<div class="card creditcard-classic_card d-flex align-items-center" style="margin: 0 auto; margin-bottom: 16px;">
							<div class="card-body creditcard-classic_card-body">
								<span class="d-flex justify-content-between"><span><img src="visa_white.svg" style="width: 20%;"><span style="color: #fff; font-size: 12px; margin-left: 5px; font-weight: 500;">Flecca Bank Classic</span></span><span><i class="fas fa-wifi"></i></span></span>
    ...
    for (var i = 0; i < num; i++) {
        ...
        // Received
        if (db.type == 'transfer' && db.receiver_identifier == event.data.identifier) {
            icon = '<td class="align-middle"><span style="background-color: #1a1a1a; padding: 5px 10px 5px 10px; border-radius: 10px;"><i class="bi bi-download"></i></span></td>';
            ...
            icon = '<td class="align-middle"><span style="background-color: #1a1a1a; padding: 5px 10px 5px 10px; border-radius: 10px;"><i class="bi bi-upload"></i></span></td>';
            data = `<td class="align-middle" style="font-weight: 500; font-size: 16px;">
						To <span style="color: #1d1e24; font-weight: 600;">${db.receiver_name}</span>
						<div style="margin-top: -5px;">Enviado</div>
					</td>`;
    ...
    gradient.addColorStop(0, 'rgba(8, 6, 145, 0.411)');
    gradient.addColorStop(1, 'rgba(8, 6, 145, 0.411)');
...
function society_page_function(event) {
    ...
    $('#page_info').html(`
		<div class="col-md-7" style="border-right: 1px solid rgba(62, 63, 75);">
			<div class="card text-center" style="background-color: transparent; border-radius: 10px; box-shadow: 0px 0px 5 0px rgba(0, 0, 0, 0.75);">
				<div class="card-header" style="background-color: #1d1e24; border-top-right-radius: 10px; border-top-left-radius: 10px;">
					<span style="color: #fff; font-size: 18px;"><i class="fas fa-chart-line"></i> Estatísticas</span>
				</div>
				<div class="card-body" style="background-color: #1a1a1a; border-bottom-left-radius: 10px; border-bottom-right-radius: 10px;">
					<div>
						<canvas id="myChart" width="100%" height="45%" style="margin-top: 5px;"></canvas>
					</div>
				</div>
			...
			<div class="row">
				<div class="col-md-12">
					<div class="card h-100" style="background-color: transparent; border-radius: 10px; box-shadow: 0px 0px 5 0px rgba(0, 0, 0, 0.75); margin-top: 12px;">
						<div class="card-header text-center" style="background-color: #1d1e24; border-top-right-radius: 10px; border-top-left-radius: 10px;">
						...
						<div class="card-body" style="background-color: #1a1a1a; border-bottom-left-radius: 10px; border-bottom-right-radius: 10px; padding: 0.6rem 1rem;">
							<table id="lastTransactionsTable">
								<tbody id="lastTransactionsData">
									<tr>
										<td class="align-middle"><span style="background-color: #1a1a1a; padding: 5px 10px 5px 10px; border-radius: 10px;"><i class="bi bi-download"></i></span></td>
									...
									<tr>
										<td class="align-middle"><span style="background-color: #1a1a1a; padding: 5px 10px 5px 10px; border-radius: 10px;"><i class="bi bi-upload"></i></span></td>
										<td class="align-middle" style="font-weight: 500; font-size: 16px;">
											De <span style="color: #1d1e24;">Arthur James</span>
											<div style="margin-top: -5px;">Recebido</div>
										</td>
										<td class="align-middle" style="font-weight: 500;"><span style="color: #1d1e24;">+ 12 750$</span> </td>
									</tr>
									<tr>
										<td class="align-middle"><span style="background-color: #1a1a1a; padding: 5px 10px 5px 10px; border-radius: 10px;"><i class="bi bi-download"></i></span></td>
										<td class="align-middle" style="font-weight: 500; font-size: 16px;">
											De <span style="color: #1d1e24;">Conta bancária</span>
											<div style="margin-top: -5px;">Sacado</div>
										</td>
										<td class="align-middle" style="font-weight: 500;"><span>- 7 000$</span> </td>
									</tr>
									<tr>
										...
										<td class="align-middle" style="font-weight: 500;"><span style="color: #1d1e24;">+ 57 000$</span> </td>
									</tr>
								</tbody>
							</table>
						</div>
		...
		<div class="col-md-5">
			<div class="col-md-12">
				<div class="card" style="background-color: transparent; border-radius: 10px; box-shadow: 0px 0px 5 0px rgba(0, 0, 0, 0.75);">
					...
					<div class="card-body" style="background-color: #1a1a1a; border-bottom-left-radius: 10px; border-bottom-right-radius: 10px; font-size: 16px;">
						<div class="card creditcard-classic_card d-flex align-items-center" style="margin: 0 auto; margin-bottom: 16px;">
							<div class="card-body creditcard-classic_card-body">
    ...
    $('#page_info').html(`
		<div class="col-md-12 d-flex flex-grow-1 flex-column h-100" style="flex: 1 1 50%;">
			<div class="card d-flex flex-column flex-grow-1" style="background-color: transparent; border-radius: 10px; box-shadow: 0px 0px 5 0px rgba(0, 0, 0, 0.75);">
				<div class="card-body flex-grow-1" style="background-color: #1a1a1a; border-bottom-left-radius: 10px; border-bottom-right-radius: 10px;">
					<div class="">
						<div class="row">
						</div>
					</div>
					...
					<div class="">
						<div class="row">
							<div class="col col-md-6 d-flex justify-content-center">
								<div class="card w-100 h-100" style="background-color: #1d1e24; border-radius: 10px; color: #fff;">
								  <div class="card-body text-center">
							...
							<div class="col col-md-6 d-flex align-items-center">
								<div class="card w-100 h-100 d-flex justify-content-center" style="background-color: #1d1e24; border-radius: 10px; color: #fff;">
