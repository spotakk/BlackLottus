...
AddEventHandler("cashmachine:machineRobbery",function(user_id,totalName,amount,bool,slot)
			...
			for k,v in pairs(machines) do
				...
				if distance <= 0.6 then
					if vSERVER.startMachine() then
						...
						objectBomb = CreateObjectNoOffset(mHash,coords.x,coords.y,coords.z + 0.25,false,false,false)
						SetEntityAsMissionEntity(objectBomb,true,true)
						FreezeEntityPosition(objectBomb,true)
						SetEntityHeading(objectBomb,v[4])
						SetModelAsNoLongerNeeded(mHash)
						vSERVER.removeC4(user_id,totalName,amount,bool,slot)
					end
				end
			end
		end
