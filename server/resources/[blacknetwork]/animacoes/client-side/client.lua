...
local animacoes = {
	...
	["dancar10"] = { dict = "anim@amb@nightclub@dancers@madonna_entourage@", anim = "hi_dance_facedj_09_v2_male^5", andar = false, loop = true },
	...
	["lenhador"] = { dict = "melee@hatchet@streamed_core", anim = "plyr_front_takedown_b", prop = "prop_tool_hammer", flag = 50, mao = 28422 },
