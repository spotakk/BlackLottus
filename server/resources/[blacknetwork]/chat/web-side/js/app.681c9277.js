(function(e) {
  function t(t) {
      for (var n, i, r = t[0], o = t[1], h = t[2], l = 0, d = []; l < r.length; l++) i = r[l], Object.prototype.hasOwnProperty.call(c, i) && c[i] && d.push(c[i][0]), c[i] = 0;
  ...
  "56d7": function(e, t, s) {
      ...
      function v(e, t, c, i, v, T) {
          return Object(n["i"])(), Object(n["d"])("div", o, [Object(n["e"])("div", h, [v.chatOpened ? (Object(n["i"])(), Object(n["d"])("div", {
              key: 0,
              class: "messages-area",
              style: Object(n["h"])({
              ...
              ref: "messagesRef"
          }, [(Object(n["i"])(!0), Object(n["d"])(n["a"], null, Object(n["l"])(T.filteredMessages, (function(e, t) {
              ...
              onClick: t[4] || (t[4] = function() {
                  return T.changeNotify && T.changeNotify.apply(T, arguments)
              })
          }, [Object(n["e"])("img", {
              style: Object(n["h"])({
          ...
          }, "CHAT", 2), (Object(n["i"])(!0), Object(n["d"])(n["a"], null, Object(n["l"])(v.chatTypes, (function(e, t) {
      ...
      var T = s("9007"),
          ...
          k = (s("96cf"), s("d3b7"), s("99af"), function() {
              var e = Object(w["a"])(regeneratorRuntime.mark((function e(t, s, n) {
                  var c, a, i;
                  return regeneratorRuntime.wrap((function(e) {
                      while (1) switch (e.prev = e.next) {
                          case 0:
                              ...
                              }, a = window.GetParentResourceName ? window.GetParentResourceName() : "santa_chat", e.next = 4, fetch("https://".concat(a, "/").concat(t), c);
                          case 4:
              ...
              methods: {
                  ...
                  send: function() {
                      "" !== this.message ? this.checkBlockedMessages() && (this.cachedMessages.length > 5 && this.cachedMessages.shift(), this.cachedMessages.push(this.message), k("ChatSubmit", {
                          ...
                          tag: "all" == this.selectedChatType ? "chat" : this.selectedChatType
