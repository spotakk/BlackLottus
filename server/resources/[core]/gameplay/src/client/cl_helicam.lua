...
local toggle_spotlight = 305 -- control id to toggle the various spotlight states Default: INPUT_PhoneCameraGrid (G)
...
local maxtargetdistance = 800 -- max distance at which target lock is maintained
...
local helicam = false
local polmav_hash = GetHashKey("BluMd500")
