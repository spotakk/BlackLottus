...
local animacoes = {
	...
	{ nome = "dancar10" , dict = "anim@amb@nightclub@dancers@madonna_entourage@" , anim = "hi_dance_facedj_09_v2_male^5" , andar = false , loop = true },
	...
	{ nome = "dildo" , dict = "amb@code_human_wander_drinking@beer@male@base" , anim = "static" , prop = "prop_cs_dildo_01" , flag = 49 , mao = 28422 },
	...
	{ nome = "dildo4" , dict = "amb@code_human_wander_drinking@beer@male@base" , anim = "static" , prop = "v_res_d_dildo_f" , flag = 49 , mao = 28422 },
	{ nome = "dildo5" , dict = "amb@code_human_wander_drinking@beer@male@base" , anim = "static" , prop = "v_res_d_dildo_b" , flag = 49 , mao = 28422 },
	{ nome = "dildo6" , dict = "amb@code_human_wander_drinking@beer@male@base" , anim = "static" , prop = "v_res_d_dildo_c" , flag = 49 , mao = 28422 },
	{ nome = "dildo7" , dict = "amb@code_human_wander_drinking@beer@male@base" , anim = "static" , prop = "v_res_d_dildo_a" , flag = 49 , mao = 28422 },
	...
	{ 
		nome = "starbucks1" , -- Nome da animação
		dict = "amb@code_human_wander_drinking@beer@male@base" , -- Dict da animação
		anim = "static" , -- Animação
		prop = "minerva_st1" , -- Props
		flag = 49 , 
		hand = 28422,
		pos1 = -0.015 , -- Posição X 
		pos2 = -0.015 ,  -- Posição Y
		pos3 = -0.155 , -- Posição Z
		pos4 = 0.0 , -- Rotação X 
		pos5 = 0.0 ,  -- Rotação Y
		pos6 = 180.0, -- Rotação Z
		propAnim = true
	},
	
	{ 
		nome = "starbucks2" , -- Nome da animação
		dict = "amb@code_human_wander_drinking@beer@male@base" , -- Dict da animação
		anim = "static" , -- Animação
		prop = "minerva_st2" , -- Props
		flag = 49 , 
		hand = 28422,
		pos1 = -0.015 , -- Posição X 
		pos2 = -0.015 ,  -- Posição Y
	...
	{ 
		nome = "starbucks3" , -- Nome da animação
		dict = "amb@code_human_wander_drinking@beer@male@base" , -- Dict da animação
		anim = "static" , -- Animação
		prop = "minerva_st3" , -- Props
		flag = 49 , 
		hand = 28422,
		pos1 = -0.015 , -- Posição X 
		pos2 = -0.015 ,  -- Posição Y
	...
	{ 
		nome = "starbucks4" , -- Nome da animação
		dict = "amb@code_human_wander_drinking@beer@male@base" , -- Dict da animação
		anim = "static" , -- Animação
		prop = "minerva_st4" , -- Props
		flag = 49 , 
		hand = 28422,
		pos1 = -0.015 , -- Posição X 
		pos2 = -0.015 ,  -- Posição Y
	...
	{ 
		nome = "starbucks5" , -- Nome da animação
		dict = "amb@code_human_wander_drinking@beer@male@base" , -- Dict da animação
		anim = "static" , -- Animação
		prop = "minerva_st5" , -- Props
		flag = 49 , 
		hand = 28422,
		pos1 = -0.015 , -- Posição X 
		pos2 = -0.015 ,  -- Posição Y
	...
	{ 
		nome = "starbucks6" , -- Nome da animação
		dict = "amb@code_human_wander_drinking@beer@male@base" , -- Dict da animação
		anim = "static" , -- Animação
		prop = "minerva_st6" , -- Props
		flag = 49 , 
		hand = 28422,
		pos1 = -0.015 , -- Posição X 
		pos2 = -0.015 ,  -- Posição Y
	...
	{ 
		nome = "starbucks7" , -- Nome da animação
		dict = "amb@code_human_wander_drinking@beer@male@base" , -- Dict da animação
		anim = "static" , -- Animação
		prop = "minerva_st7" , -- Props
		flag = 49 , 
		hand = 28422,
		pos1 = -0.015 , -- Posição X 
		pos2 = -0.015 ,  -- Posição Y
	...
	{ 
		nome = "cam" , -- Nome da animação
		dict = "mic_4_int-0" , -- Dict da animação
		anim = "a_m_y_hipster_01-0" , -- Animação
		prop = "minerva_cam" , -- Props
		flag = 49 , 
		hand = 60309,
		pos1 = 0.030 , -- Posição X
		pos2 = 0.010 , -- Posição Y
		pos3 = 0.090 , -- Posição Z
		pos4 = 250.0 , -- Rotação X
		pos5 = 230.0 , -- Rotação Y
		pos6 = 40.0 , -- Rotação Z
		propAnim = true 
	},
	
	{ 
		nome = "bebida" , -- Nome da animação
		dict = "amb@world_human_aa_coffee@base" , -- Dict da animação
		anim = "base" , -- Animação
		prop = "prop_fib_coffee" , -- Props
		flag = 49 , 
		hand = 28422,
		pos1 = 0.0 , -- Posição X
		pos2 = -0.010 , -- Posição Y
		pos3 = -0.010 , -- Posição Z
		pos4 = -05.0 , -- Rotação X
		pos5 = 0.0 , -- Rotação Y
		pos6 = 0.0 , -- Rotação Z
		propAnim = true 
	...
	{ 
		nome = "bebida1" , -- Nome da animação
		dict = "amb@world_human_aa_coffee@base" , -- Dict da animação
		anim = "base" , -- Animação
		prop = "prop_cs_paper_cup" , -- Props
		flag = 49 , 
		hand = 28422,
		pos1 = 0.0 , -- Posição X
		pos2 = -0.010 , -- Posição Y
	...
	{ 
		nome = "bebida3" , -- Nome da animação
		dict = "amb@world_human_aa_coffee@base" , -- Dict da animação
		anim = "base" , -- Animação
		prop = "prop_plastic_cup_02" , -- Props
		flag = 49 , 
		hand = 28422,
		pos1 = 0.0 , -- Posição X
		pos2 = -0.010 , -- Posição Y
