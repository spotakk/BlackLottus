...
local vehglobal = {
	...
	["AGSamarokpm"] = {"Amarok",40,10000,"work",0 },
	["AGSgt86pm"] = {"Toyota GT86",40,10000,"work",0 },
	["AGSlc500pm"] = {"Lexus LC500",40,10000,"work",0 },
	["AGSm5pm"] = {"BMW M5",40,10000,"work",0 },
	["AGStundrapm"] = {"Tundra",40,10000,"work",0 },
	["AGSx6pm"] = {"BMW X6",40,10000,"work",0 },

	["AGScb650pm"] = {"CB 650",40,10000,"work",0 },
	["AGStigerpm"] = {"Triumph Tiger",40,10000,"work",0 },
	["AGSinsurgentpm"] = {"Insurgent",40,10000,"work",0 },
	...
	["BluX6m"] = {"BMW X6",40,10000,"work",0 },
	["BluQuattroporte"] = {"Quattroporte",40,10000,"work",0 },
	["BluInsurgent"] = {"Insurgent",40,10000,"work",0 },
	["BluTundra"] = {"Tundra",40,10000,"work",0 },
	["BluAmarok"] = {"Amarok",40,10000,"work",0 },
	["BluLevante"] = {"Levante",40,10000,"work",0 },
	["Blu412"] = {"B412",40,10000,"work",0 },
	["BluMd500"] = {"MD 500",40,10000,"work",0 },
	["BluR1200"] = {"R1200",40,10000,"work",0 },
	["BluTiger"] = {"Tiger 900",40,10000,"work",0 },
	["BluM140"] = {"BMW M140",40,10000,"work",0 },
	["BluGS350"] = {"GS350",40,10000,"work",0 },
	["BluTesla"] = {"Tesla Model",40,10000,"work",0 },
	["BluM4c"] = {"BMW M4",40,10000,"work",0 },
	["BluM5"] = {"BMW M5",40,10000,"work",0 },
	["BluGT86"] = {"GT 86",40,10000,"work",0 },


	["bmwm3"] = {"BMW M3",40,10000,"work",0 },
	["bmwm4"] = {"BMW M4",40,10000,"work",0 },
	["bmwm5"] = {"BMW M5",40,10000,"work",0 },
	["jettagli"] = {"Jetta GLI",40,10000,"work",0 },
	["fpace"] = {"Jaguar",40,10000,"work",0 },
	["tiger900"] = {"Tiger 9000",40,10000,"work",0 },
	["tundra"] = {"Tundra",40,10000,"work",0 },
	["e63"] = {"Mercedes E63",40,10000,"work",0 },
	...
	["nd600lt3"] = {"Mc Laren Senna",40,10000,"work",0 },
	["ndguincho"] = {"Guincho",40,10000,"work",0 },
	["ndmaverick2"] = {"Maverick",40,10000,"work",0 },
	["ndr1200mec"] = {"R1200",40,10000,"work",0 },
	
	["VRdm1200"] = {"DM 1200",40,10000,"work",0 },
	["VRq8"] = {"Audi Q8",40,10000,"work",0 },
	["VRraptor"] = {"Raptor",40,10000,"work",0 },
	["VRrs5"] = {"Audi RS5",40,10000,"work",0 },
	["VRrs6"] = {"Audi RS6",40,10000,"work",0 },
	["VRrs6av"] = {"Audi A6",40,10000,"work",0 },
	["VRtahoe"] = {"Tahoe",40,10000,"work",0 },
	["VRa4"] = {"Audi A4",40,10000,"work",0 },
	["VRa3"] = {"Audi A3",40,10000,"work",0 },

	["polr34"] = {"Nissan Skyline R34",40,10000,"work",0 },
	["polgtr50"] = {"Nissan GTR 50",40,10000,"work",0 },
	["polgt17"] = {"Ford GT",40,10000,"work",0 },
	["polgtr"] = {"Nissan GTR R35",40,10000,"work",0 },

	["WRr1200"] = {"R1200",40,10000,"work",0 },
	["WRTiger900"] = {"Tiger 900",40,10000,"work",0 },

	["WRbmwx6"] = {"BMW X6",40,10000,"work",0 },
	["WRbmwx7"] = {"BMW X7",40,10000,"work",0 },
	["WRxc90"] = {"XC 90",40,10000,"work",0 },
	["WRyukon"] = {"Yukon",40,10000,"work",0 },
	["WRgle"] = {"Mercedes GLE",40,10000,"work",0 },
	["WRm5"] = {"BMW M5",40,10000,"work",0 },

	["bcat"] = {"Caveirão CORE",40,10000,"work",0 },
	["WRsilverado"] = {"Silverado",40,10000,"work",0 },
	["WRclassxv2"] = {"Mercedes XCLASS",40,10000,"work",0 },


-----------------------------------------------------------------------------------------------------------------------------------------
-- VEHVIPS
-----------------------------------------------------------------------------------------------------------------------------------------
	["audirs6"] = { "Audi RS6",50,100,"rental",60 }, -- X
	["pm19"] = { "Porsche Cayene",50,100,"rental",60 }, -- X
	["aventador"] = { "Lamborghini Aventador",30,100,"rental",60 }, -- X
	["bentleybacalar"] = { "Bentley Bacalar",50,100,"rental",60 }, -- X
	["bloodline"] = { "Bloodline King",30,100,"rental",60 }, -- X
	["bmwi8"] = { "BMW I8",30,100,"rental",60 }, -- X
	["bmwm1wb"] = { "BMW M1 Widebody",50,100,"rental",60 }, -- X
	["bmwm4gts"] = { "BMW M4 GTS",50,100,"rental",60 }, -- X
	["bmwm5e34"] = { "BMW M5 e34",40,100,"rental",60 }, -- X
	["bugattiatlantic"] = { "Bugatti Atlantic",40,100,"rental",60 }, -- X
	["camaro"] = { "Chevrolet Camaro",35,100,"rental",60 }, -- X
	["civictyper"] = { "Honda Civic Type-R",50,100,"rental",60 }, -- X
	["corvettec7"] = { "Corvette C7",40,100,"rental",60 }, -- X
	["dodgecharger1970"] = { "Dodge Charger 1970",40,100,"rental",60 }, -- X
 	["dodgechargerrt69"] = { "Dodge Charger RT69",50,100,"rental",60 }, -- X
	["dodgechargersrt"] = { "Dodge Charger SRT",40,100,"rental",60 }, -- X
	["escalade2021"] = { "Escalade 2021",50,100,"rental",60 },-- X
	["escaladegt900"] = { "Escalade GT900",50,100,"rental",60 },-- X
	["ferrari812"] = { "Ferrari 812",30,100,"rental",60 },-- X
	["ferrarif12"] = { "Ferrari F12",30,100,"rental",60 },-- X
	["ferrarif40"] = { "Ferrari F40",30,100,"rental",60 },-- X
	["ferrariitalia"] = { "Ferrari Italia",30,100,"rental",60 },-- X
	["fordmustang"] = { "Ford Mustang",40,100,"rental",60 },-- X
	["golfgti"] = { "Golf GTi",50,100,"rental",60 },-- X
	["golfmk7"] = { "Golf Mk7",40,100,"rental",60 },-- X
	["jeepcherokee"] = { "Jeep Cherokee",40,100,"rental",60 },-- X
	["lamborghinihuracan"] = { "Lamborghini Huracan",40,100,"rental",60 },-- X
	["lamborghinihuracanlw"] = { "Lamborghini LW",40,100,"rental",60 },-- X
	["lancerevolution9"] = { "Lancer Evolution IX",50,100,"rental",60 },-- X
	["lancerevolutionx"] = { "Lancer Evolution X",50,100,"rental",60 },-- X-- X
	["m8competition"] = { "BMW M8 Competition",50,100,"rental",60 },-- X
	["mazdarx7"] = { "Mazda RX7",40,100,"rental",60 },-- X
	["mazdarx72"] = { "Mazda RX7 RB",40,100,"rental",60 },-- X
	["mclarensenna"] = { "McLaren Senna",30,100,"rental",60 },
	["mercedesgt63"] = { "Mercedes GT63",50,100,"rental",60 },
	["mercedesg65"] = { "Mercedes G65",50,100,"rental",60 },
	["mustang1969"] = { "Ford Mustang 1969",40,100,"rental",60 },
	["mustangfast"] = { "Mustang Fastback",50,100,"rental",60 },
	["nissangtr"] = { "Nissan GT-R R35",30,100,"rental",60 },
	["nissangtr2"] = { "Nissan GT-R EE",30,100,"rental",60 },
	["nissangtr3"] = { "Nissan GT-R RB",30,100,"rental",60 },-- X
	["nissangtrnismo"] = { "Nissan GT-R Nismo",40,100,"rental",60 },-- X
	["skyliner34"] = { "Skyline R34",40,100,"rental",60 },-- X
	["skyliner342"] = { "Skyline R34 FF",40,100,"rental",60 },-- X
	["subaruimpreza"] = { "Subaru Impreza",50,100,"rental",60 }, -- X
	["subarubrz"] = { "Subaru Brz RB",50,100,"rental",60 }, -- X
	["toyotasupra"] = { "Toyota Supra",40,100,"rental",60 }, -- X
	["toyotasupra2"] = { "Toyota Supra 2020",40,100,"rental",60 }, -- X
	["porsche911"] = { "Porsche 911 GT3",40,100,"rental",60 },
	["urbandevil"] = { "Urban Devil",30,100,"rental",60 },
	["wheelchair"] = { "Cadeira de Rodas",10,1000,"rental",60 }, -- X
	["s1000rr1"] = { "s1000rr1",10,1000,"rental",60 }, -- X
	["350z"] = { "Nissan 350z RB",40,100,"rental",60 }, -- X
	["audir8"] = { "Audi R8",40,100,"rental",60 }, -- X
	["r6"] = { "Yamaha R6",25,100,"rental",60 },-- X
	["silvias15"] = { "Nissan Silvia S15",30,100,"rental",60 },-- X
	["rangerover"] = { "Range Rover",60,100,"rental",60 },-- X
	["shelbygt500"] = { "Shelby GT500",50,100,"rental",60 },-- X
	["panameramansory"] = { "Porsche Panamera",50,100,"rental",60 },-- X

-----------------------------------------------------------------------------------------------------------------------------------------
-- EXTRAS
-----------------------------------------------------------------------------------------------------------------------------------------
	["Wrgle53"] = {"Mercedes GLE",40,10000,"work",0 },
	["Wrasprinter"] = {"Sprinter",40,10000,"work",0 },
	...
	["rmodg65"] = {"Mercedes G65",40,10000,nil, 0 },
	["rangerovervelar"] = {"Velar",40,10000,nil, 0 },
	["r1250"] = {"r1250",40,10000,nil, 0 },
    ...
    ["B412"] = {"Caçador B412",40,5000,"work",0 },
	...
	["lancerevolutionx"] = { "Lancer Evolution X",50,100,nil,60 },
	["lancerevolution9"] = { "Lancer Evolution IX",50,100,nil,60 },
	["astonmartindbs"] = { "Aston Martin DBS",30,100,nil,60 },
	["nissangtr50"] = { "Nissan GT-R 50th",30,100,nil,60 },
	["mercedesamg63"] = { "Mercedes C63-S",50,100,nil,60 },
	["r1"] = { "Yamaha R1",25,100,nil,60 },
	["vwtouareg"] = { "Volkswagen Touareg",60,100,nil,60 },
	["Wra45"] = { "Mercedes A45",10,1000,"work",0 },
	["jester5"] = { "Jester 5",30,100,nil,75 },
	["roxanne"] = { "Roxanne",50,100,nil,75 },
	["sunrise"] = { "Sunrise",50,100,nil,75 }
}
-----------------------------------------------------------------------------------------------------------------------------------------
-- VEHICLEGLOBAL
-----------------------------------------------------------------------------------------------------------------------------------------
