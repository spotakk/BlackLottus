vehicleCustomisationPrices = {
	cosmetics = 1000,
	respray = 1000,
	engines = { 999999, 10000, 20000, 30000, 40000, 50000 },
	brakes = { 999999, 10000, 20000, 30000, 40000, 50000 },
	transmission = { 999999, 10000, 20000, 30000, 40000, 50000 },
	suspension = { 999999, 10000, 20000, 30000, 40000, 50000 },
	shield = { 999999, 20000, 30000, 40000, 50000, 60000 },
	turbo = 1000,
	wheels = 1500,
	customwheels = 1000,
	wheelsmoke = 500,
