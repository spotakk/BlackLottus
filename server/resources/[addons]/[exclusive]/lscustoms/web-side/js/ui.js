window.onload = function(e){
	...
	function createMenu(menu,heading,subheading){
		menuStructure[menu] = {
			...
			container: "<ul id = 'menu_items' class = '" + menu + "' style = 'display: none; order: 3;'></ul>",
			items: {},
			itemsArray: {}
		}
	...
	function populateMenu(menu,id,item,item2){
		...
		if(item2 == "none"){
			$("." + menu).append("<li class = '" + id + " active'><span class = 'item1'>" + item + "</span><div/><span class='iconify' data-icon='material-symbols:arrow-back-ios-new'></span></li>");
		} else {
			$("." + menu).append("<li class = '" + id + " active'><span class = 'item1'>" + item + "</span> <span class = 'item2' style = 'float: right;'>" + item2 + "</span><div/><span class='iconify' data-icon='material-symbols:arrow-back-ios-new'></span></li>");
		}
	}
